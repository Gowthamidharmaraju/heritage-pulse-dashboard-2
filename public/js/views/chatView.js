      ...
      <div class="view-header" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 8px;">
          <span class="badge" style="background: rgba(16, 185, 129, 0.15); color: #10b981; border: 1px solid rgba(16, 185, 129, 0.3); font-weight: 700; display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px;">
            <span style="width: 8px; height: 8px; background: #10b981; border-radius: 50%; display: inline-block; animation: pulse 1.5s infinite;"></span> Real-Time Connected
          </span>
        </div>
      </div>
        ...
        return `
          <div style="display: flex; align-items: center; gap: 8px; padding: 6px 8px; border-radius: 6px; background: rgba(255,255,255,0.02);">
            <div style="position: relative;">
              <div style="width: 28px; height: 28px; border-radius: 50%; background: var(--saffron); color: #000; font-weight: 700; font-size: 0.75rem; display: flex; align-items: center; justify-content: center;">
                ${u.avatar || u.name.charAt(0)}
              </div>
              <span style="position: absolute; bottom: -1px; right: -1px; width: 8px; height: 8px; background: ${statusColor}; border-radius: 50%; border: 1.5px solid var(--bg-card-subtle);" title="${statusText}"></span>
            </div>
            <div style="min-width: 0; flex: 1;">
              ...
              <div style="font-size: 0.68rem; color: ${isActive ? '#10b981' : 'var(--text-dim)'}; font-weight: 500;">
    ...
    try {
      ...
      this.evtSource.onmessage = (e) => {
        try {
          ...
          if (msg) {
            // Play chime if message came from someone else
